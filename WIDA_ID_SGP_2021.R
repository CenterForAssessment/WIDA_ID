##########################################################################################
###
### Script for calculating SGPs for 2020-2021 WIDA/ACCESS Idaho
###
##########################################################################################
...
load("Data/WIDA_ID_Data_LONG_2021.Rdata")

###   Add single-cohort baseline matrices to SGPstateData
SGPstateData <- SGPmatrices::addBaselineMatrices("WIDA_ID", "2021")

### Run analyses
WIDA_ID_SGP <- updateSGP(
		WIDA_ID_SGP,
		WIDA_ID_Data_LONG_2021,
